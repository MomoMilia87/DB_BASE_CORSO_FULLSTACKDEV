<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['aggiungi'])){
        ...
        $stmt = $conn->prepare("INSERT INTO destinazioni (citta, paese, prezzo, data_partenza, data_ritorno, posti_disponibili) 
                                VALUES  (?, ?, ?, ?, ?, ?)");
        //Binding dei parametri e tipizzo (s: string, i: integer/double)
    ...
    //LOGICA DI MODIFICA (Recupero Dati)
    ...
    if(isset($_GET['elimina'])){
        ...
        echo "<div class='alert alert-danger'>Destinazione Cancellata correttamente</div>";
    }
            ...
            <form action="" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="prezzo" class="form-control" placeholder="es.: 500" 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="posti_disponibili" class="form-control" placeholder="es.: 20" 
